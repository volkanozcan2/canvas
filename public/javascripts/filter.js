/*!
 * pixi-filters - v3.0.2
 * Compiled Tue, 14 May 2019 17:05:19 UTC
 *
...
var __filters = function(e, t, n, r, o, i, l, s) {
    ...
    var a = "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\n\nvarying vec2 vTextureCoord;\n\nvoid main(void)\n{\n    gl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);\n    vTextureCoord = aTextureCoord;\n}",
            ...
            return t.prototype.apply = function(e, t, n, r) {
                ...
                r.kernels.set = function(e) {
                    Array.isArray(e) && e.length > 0 ? (this._kernels = e,
                        ...
                        this._blur = Math.max.apply(Math, e)) : (this._kernels = [0],
                        this._quality = 1)
                },
                ...
                r.pixelSize.set = function(e) {
                    "number" == typeof e ? (this._pixelSize.x = e,
                        this._pixelSize.y = e) : Array.isArray(e) ? (this._pixelSize.x = e[0],
                        this._pixelSize.y = e[1]) : e instanceof n.Point ? (this._pixelSize.x = e.x,
        ...
        A = function(e) {
            function t(t, o, a, u) {
                ...
                void 0 === t && (t = 2),
                    ...
                    e.call(this),
                    "number" == typeof t ? (c = t,
                        f = t) : t instanceof n.Point ? (c = t.x,
                        f = t.y) : Array.isArray(t) && (c = t[0],
                        f = t[1]),
            ...
            return n.prototype.apply = function(e, t, n, r) {
                ...
                r.colorMap.set = function(e) {
                    e instanceof t.Texture || (e = t.Texture.from(e)),
                        e && e.baseTexture && (e.baseTexture.scaleMode = this._scaleMode,
        ...
        V = function(e) {
            function t(t) {
                t && t.constructor !== Object && (console.warn("DropShadowFilter now uses options instead of (rotation, distance, blur, color, alpha)"),
                        t = {
                            rotation: t
                        },
    ...
    var re = a,
        ...
        ie = function(e) {
            function t(t, n, r, o, i) {
                void 0 === t && (t = 10),
                    ...
                    void 0 === o && (o = 16777215),
                    void 0 === i && (i = .1),
                    e.call(this, re, oe.replace(/%QUALITY_DIST%/gi, "" + (1 / i / t).toFixed(7)).replace(/%DIST%/gi, "" + t.toFixed(7))),
        ...
        ue = function(e) {
            function t(t) {
                e.call(this, le, ae.replace("${perlin}", se)),
                    this.uniforms.dimensions = new Float32Array(2),
                    "number" == typeof t && (console.warn("GodrayFilter now uses options instead of (angle, gain, lacunarity, time)"),
                        t = {
                            angle: t
                        },
        ...
        he = function(e) {
            ...
            return t.prototype.apply = function(e, t, n, r) {
                ...
                r.velocity.set = function(e) {
                    Array.isArray(e) ? this._velocity.set(e[0], e[1]) : (e instanceof n.Point || e instanceof n.ObservablePoint) && this._velocity.copy(e)
                },
        ...
        me = function(e) {
            function t(t, n, r) {
                void 0 === n && (n = .05),
                    void 0 === r && (r = null),
                    r = r || t.length,
                    e.call(this, pe, de.replace(/%maxColors%/g, r)),
                    this.epsilon = n,
                    this._maxColors = r,
        ...
        _e = function(e) {
            function t(n, r, o) {
                ...
                e.call(this, ye, be.replace(/\$\{angleStep\}/, l)),
        ...
        Le = function(e) {
            function t(t, n, r) {
                void 0 === t && (t = [0, 0]),
                    ...
                    e.call(this, je, ke),
                    this.center = t,
                    Array.isArray(n) && (console.warn("Deprecated Warning: ShockwaveFilter params Array has been changed to options Object."),
                        n = {}),
                    n = Object.assign({
                        amplitude: 30,
                        wavelength: 160,
        ...
        qe = function(e) {
            function t(t, r, o, i) {
                void 0 === t && (t = 100),
                    ...
                    this.uniforms.texSize = new n.Point(window.innerWidth, window.innerHeight),
                    this.updateDelta()
            }
            e && (t.__proto__ = e),
                t.prototype = Object.create(e && e.prototype),
        ...
        Ye = function(e) {
            function t(t, n, r, o) {
                void 0 === t && (t = 100),
                    ...
                    void 0 === o && (o = null),
                    e.call(this),
                    this.tiltShiftXFilter = new We(t, n, r, o),
                    this.tiltShiftYFilter = new Ke(t, n, r, o)
            }
            e && (t.__proto__ = e),
                t.prototype = Object.create(e && e.prototype),
                t.prototype.constructor = t;
    ...
    return e.AdjustmentFilter = c,
        e.AdvancedBloomFilter = y,
        e.AsciiFilter = C,
        e.BevelFilter = z,
        e.BloomFilter = A,
        e.BulgePinchFilter = D,
        e.CRTFilter = K,
        e.ColorMapFilter = M,
        e.ColorReplaceFilter = k,
        e.ConvolutionFilter = E,
        e.CrossHatchFilter = N,
        e.DotFilter = Q,
        e.DropShadowFilter = V,
        e.EmbossFilter = J,
        e.GlitchFilter = ne,
        e.GlowFilter = ie,
        e.GodrayFilter = ue,
        e.KawaseBlurFilter = d,
        e.MotionBlurFilter = he,
        e.MultiColorReplaceFilter = me,
        e.OldFilmFilter = xe,
        e.OutlineFilter = _e,
        e.PixelateFilter = Fe,
        e.RGBSplitFilter = Re,
        e.RadialBlurFilter = we,
        e.ReflectionFilter = Oe,
        e.ShockwaveFilter = Le,
        e.SimpleLightmapFilter = Be,
        e.TiltShiftAxisFilter = qe,
        e.TiltShiftFilter = Ye,
        e.TiltShiftXFilter = We,
        e.TiltShiftYFilter = Ke,
        e.TwistFilter = Ue,
        e.ZoomBlurFilter = He,
        e
}({}, PIXI, PIXI, PIXI, PIXI, PIXI, PIXI.filters, PIXI.filters);
